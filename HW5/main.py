...
from sparse_to_fill import PruningWeight
...
def main():
    ...
    parser.add_argument('--ratio', default=0.5, help='how much weight will be removed')
    ...
    prune = PruningWeight(ratio=args.ratio)
    prune.Init(model)    
